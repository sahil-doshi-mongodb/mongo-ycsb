...
# =============================================================
# run-benchmark-v7.sh
# Zepto MongoDB Benchmark Coordinator — v7 Cluster
#
# Run this on EC2 Instance 1 (connected to v7 cluster).
# Run run-benchmark-v8.sh simultaneously on EC2 Instance 2.
#
# BEFORE RUNNING:
#   1. Fill in connection.uri in all 6 files under configs/zepto-v7/
#   2. Fill in results.mongodb.uri in all 6 files under configs/zepto-v7/
...
echo "  │                                                     │"
echo "  │  Coordinate with the operator on EC2 Instance 2.   │"
